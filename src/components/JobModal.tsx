                    ...
                    <Box>
                      <HStack mb="10px">
                        <FormControl>
                          ...
                          <Input value={job.name} placeholder="Full Stack Developer" name="name" onInput={onInputHandler} />
                        </FormControl>
                        <FormControl>
                          <FormLabel>Company</FormLabel>
                          <Input value={job.company} placeholder="Dream Company ltd." name="company" onInput={onInputHandler} />
                        </FormControl>
                      </HStack>
                      <HStack mb="10px">
                        <FormControl>
                          <FormLabel>Location</FormLabel>
                          <Input value={job.location} name="location" placeholder="NYC, SF, Remote..." onInput={onInputHandler} />
                        </FormControl>
                        <FormControl>
